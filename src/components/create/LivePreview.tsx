      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="flex items-center gap-2 p-2 rounded-lg bg-secondary/50">
          ...
          <span className="text-sm">
            <span className="font-bold">{data.player_count}</span> joueurs
          </span>
        </div>
        <div className="flex items-center gap-2 p-2 rounded-lg bg-secondary/50">
          <Grid3X3 className="w-4 h-4 text-muted-foreground" />
          <span className="text-sm">
            <span className="font-bold">{cellsPerGrid}</span> cases
          </span>
        </div>
        <div className="flex items-center gap-2 p-2 rounded-lg bg-secondary/50">
          <FileStack className="w-4 h-4 text-muted-foreground" />
          <span className="text-sm">
            <span className="font-bold">{totalPages}</span> page{totalPages > 1 ? "s" : ""}
          </span>
        </div>
        <div className="flex items-center gap-2 p-2 rounded-lg bg-secondary/50">
            ...
            >
              <div
                className={cn(
                  ...
                  data.grids_per_page === 2 && "grid-cols-2",
                  data.grids_per_page === 4 && "grid-cols-2 grid-rows-2"
                )}
              >
